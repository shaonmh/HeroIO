  ...
  return (
    <div>
      <div className=" mx-auto mt-15 text-center">
        <h1 className="text-7xl text-slate-700 font-bold">
          We Build <br />
          <span className="text-violet-500">Productive</span> Apps
        </h1>
        <p className="w-6/10 mx-auto text-lg my-10 text-gray-500">
        ...
        <div className="flex my-10 justify-center flex-col">
          ...
          <div className="herobottom  bg-gradient-to-r from-indigo-500 to-violet-700 text-gray-50 p-10 rounded-lg -bottom-10">
            ...
            <div className="flex justify-center gap-20 mt-10 text-gray-300">
              ...
              <div className="flex flex-col gap-5">
                <p>Active Apps</p>
                <h1 className="text-6xl text-white font-bold">132+</h1>
